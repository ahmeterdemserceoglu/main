...
import { Users, Package, MessageSquare, Flag, BarChart3, Settings, ShoppingBag, RotateCcw } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                {stats.pendingRequests === 0 && stats.pendingReturns === 0 && stats.pendingReports === 0 && (
